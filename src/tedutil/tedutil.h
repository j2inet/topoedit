...
EXTERN_C const IID IID_ITedVideoWindowHandler;
    ...
    typedef struct ITedVideoWindowHandlerVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITedVideoWindowHandler, GetVideoWindow)
        HRESULT ( STDMETHODCALLTYPE *GetVideoWindow )( 
            ITedVideoWindowHandler * This,
            /* [out] */ LONG_PTR *pHwnd);
        
        DECLSPEC_XFGVIRT(ITedVideoWindowHandler, ReleaseVideoWindow)
...
EXTERN_C const IID IID_ITedTopoEventHandler;
    ...
    typedef struct ITedTopoEventHandlerVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITedTopoEventHandler, NotifyAddedNode)
        HRESULT ( STDMETHODCALLTYPE *NotifyAddedNode )( 
            ITedTopoEventHandler * This,
            int nNodeID);
        
        DECLSPEC_XFGVIRT(ITedTopoEventHandler, NotifyRemovedNode)
        HRESULT ( STDMETHODCALLTYPE *NotifyRemovedNode )( 
            ITedTopoEventHandler * This,
            int nNodeID);
        
        DECLSPEC_XFGVIRT(ITedTopoEventHandler, NotifyConnection)
        HRESULT ( STDMETHODCALLTYPE *NotifyConnection )( 
            ITedTopoEventHandler * This,
            int nUpNodeID,
            int nDownNodeID);
        
        DECLSPEC_XFGVIRT(ITedTopoEventHandler, NotifyDisconnection)
...
EXTERN_C const IID IID_ITedPropertyInfo;
    ...
    typedef struct ITedPropertyInfoVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITedPropertyInfo, GetPropertyInfoName)
        ...
        DECLSPEC_XFGVIRT(ITedPropertyInfo, GetPropertyCount)
        HRESULT ( STDMETHODCALLTYPE *GetPropertyCount )( 
            ITedPropertyInfo * This,
            /* [out] */ DWORD *pdwCount);
        
        DECLSPEC_XFGVIRT(ITedPropertyInfo, GetProperty)
        ...
        DECLSPEC_XFGVIRT(ITedPropertyInfo, GetPropertyType)
        HRESULT ( STDMETHODCALLTYPE *GetPropertyType )( 
            ITedPropertyInfo * This,
            /* [in] */ DWORD dwIndex,
            /* [out] */ VARTYPE *pVT);
        
        DECLSPEC_XFGVIRT(ITedPropertyInfo, IsWriteable)
        HRESULT ( STDMETHODCALLTYPE *IsWriteable )( 
            ITedPropertyInfo * This);
        
        DECLSPEC_XFGVIRT(ITedPropertyInfo, SetProperty)
...
EXTERN_C const IID IID_ITedPropertyController;
    ...
    typedef struct ITedPropertyControllerVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITedPropertyController, ClearProperties)
        HRESULT ( STDMETHODCALLTYPE *ClearProperties )( 
            ITedPropertyController * This);
        
        DECLSPEC_XFGVIRT(ITedPropertyController, AddPropertyInfo)
...
EXTERN_C const IID IID_ITedTopoView;
    ...
    typedef struct ITedTopoViewVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITedTopoView, Init)
        ...
        DECLSPEC_XFGVIRT(ITedTopoView, CreateTopoWindow)
...
EXTERN_C const IID IID_ITedDataSaver;
    ...
    typedef struct ITedDataSaverVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITedDataSaver, Init)
        HRESULT ( STDMETHODCALLTYPE *Init )( 
            ITedDataSaver * This,
            LPCWSTR strDocName);
        
        DECLSPEC_XFGVIRT(ITedDataSaver, BeginSaveObject)
        HRESULT ( STDMETHODCALLTYPE *BeginSaveObject )( 
            ITedDataSaver * This,
            LPCWSTR strName);
        
        DECLSPEC_XFGVIRT(ITedDataSaver, BeginSaveChildObjects)
        HRESULT ( STDMETHODCALLTYPE *BeginSaveChildObjects )( 
            ITedDataSaver * This);
        
        DECLSPEC_XFGVIRT(ITedDataSaver, EndSaveChildObjects)
        HRESULT ( STDMETHODCALLTYPE *EndSaveChildObjects )( 
            ITedDataSaver * This);
        
        DECLSPEC_XFGVIRT(ITedDataSaver, SaveData)
        HRESULT ( STDMETHODCALLTYPE *SaveData )( 
            ITedDataSaver * This,
            LPCWSTR strName,
            LPCWSTR strValue);
        
        DECLSPEC_XFGVIRT(ITedDataSaver, SaveToFile)
...
EXTERN_C const IID IID_ITedDataLoader;
    ...
    typedef struct ITedDataLoaderVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ITedDataLoader, LoadFromFile)
